...
// List of available models: https://openrouter.ai/docs#models
const MODEL = "mistral/mistral-7b-instruct" // Fast and cheap model
    ...
    try {
      const response = await fetch(API_URL, {
        ...
        headers: {
          ...
          'HTTP-Referer': 'https://github.com/cogentapps/chat-with-gpt',
          'X-Title': 'AI Rock Paper Scissors Game'
        },
        body: JSON.stringify({
          model: MODEL,
          messages: [
